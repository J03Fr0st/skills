...
Items whose value, acceptance, boundary, or readiness remain unresolved return
to `/agile-refine` through explicit user invocation. Detailed implementation
steps remain in the repository's technical planning workflow.
